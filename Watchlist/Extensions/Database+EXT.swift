...
//                }
//
//                let mediaModel = MediaModel(id: id, title: title, watched: false, mediaType: mediaType.rawValue, personalRating:
//                nil, genreIDs: genreIDsToString, media: try JSONEncoder().encode(media))
