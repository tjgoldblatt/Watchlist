    ...
    let mediaMock: [DBMedia] = [
        ...
        DBMedia(
            media: Media(mediaType: .tv,
                         ...
                         originCountry: nil,
                         originalLanguage: nil,
                         name: "The Caped Crusader is teamed up with Blue Beetle, Green Arrow, Aquaman and countless others in his quest to uphold justice.",
                         adult: nil,
                         releaseDate: nil,
                         title: nil,
                         video: nil,
        ...
        DBMedia(
            media: Media(mediaType: .movie,
                         ...
                         title: "As Gotham City\'s young vigilante, the Batman, struggles to pursue a brutal serial killer, district attorney Harvey Dent gets caught in a feud involving the criminal family of the Falcones.",
                         video: nil,
                         profilePath: nil,
                         knownFor: nil), watched: false, personalRating: 7.0),
        ...
        DBMedia(
            media: Media(mediaType: .tv,
                         ...
                         adult: nil,
                         releaseDate: nil,
                         title: "The Caped Crusader is teamed up with Blue Beetle, Green Arrow, Aquaman and countless others in his quest to uphold justice.",
                         video: nil,
                         profilePath: nil,
                         knownFor: nil),
            watched: true, personalRating: 2),
